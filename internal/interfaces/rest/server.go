...
func (s *Server) routes() {
	...
	s.app.Get("/api/coinmarketcap/summary", s.coinMarketCapSummary)
	s.app.Get("/api/coinmarketcap/assets", s.coinMarketCapAssets)
	s.app.Get("/api/coinmarketcap/ticker", s.coinMarketCapSummary)
	s.app.Get("/api/coinmarketcap/orderbook", s.publicOrderBook)
	s.app.Get("/api/coinmarketcap/trades", s.publicTrades)
	s.app.Get("/api/coingecko/pairs", s.coinGeckoPairs)
	s.app.Get("/api/coingecko/tickers", s.coinGeckoTickers)
	s.app.Get("/api/coingecko/orderbook", s.publicOrderBook)
	s.app.Get("/api/coingecko/historical_trades", s.publicTrades)
	s.app.Get("/api/v3/time", s.binanceTime)
	s.app.Get("/api/v3/exchangeInfo", s.binanceExchangeInfo)
	s.app.Get("/api/v3/ticker/24hr", s.binanceTicker24h)
	s.app.Get("/api/v3/depth", s.binanceDepth)
	s.app.Get("/api/v3/trades", s.binanceTrades)
	s.app.Get("/api/v3/historicalTrades", s.binanceTrades)
	s.app.Get("/api/v3/klines", s.binanceKlines)
	s.app.Get("/api/v3/account", s.binanceAccount)
	s.app.Post("/api/v3/order", s.binancePlaceOrder)
	s.app.Get("/api/v3/order", s.binanceGetOrder)
	s.app.Delete("/api/v3/order", s.binanceCancelOrder)
	s.app.Get("/api/v3/openOrders", s.binanceOpenOrders)
	s.app.Get("/api/v3/allOrders", s.binanceAllOrders)
	s.app.Get("/api/v3/myTrades", s.binanceMyTrades)
