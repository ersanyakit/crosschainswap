...
const openAPISpec = `{
  ...
  "paths": {
    ...
    "/v1/assets": {
      "get": {
        "tags": ["Prices"],
        "summary": "List gateway-backed registry assets with deployment metadata and icons",
        "responses": {
    ...
    "/v1/users/{user_id}/deposit-addresses": {
      "post": {
        "tags": ["Deposits"],
        "summary": "Create or retrieve a gateway static deposit address",
        "description": "Calls the payment gateway static-address endpoint server-side and returns the gateway deposit address plus an exchange QR proxy URL.",
        "security": [{ "oidcSession": [] }],
        "parameters": [{ "$ref": "#/components/parameters/UserID" }],
        "requestBody": { "required": true, "content": { "application/json": { "schema": { "$ref": "#/components/schemas/DepositAddressRequest" } } } },
        "responses": {
          "200": { "description": "Deposit address", "content": { "application/json": { "schema": { "$ref": "#/components/schemas/DepositAddress" } } } },
          "400": { "$ref": "#/components/responses/Error" },
    ...
    "/v1/payment-gateway/qrcode": {
      "get": {
        "tags": ["Deposits"],
        "summary": "Proxy gateway address QR code",
        "description": "Returns the PNG generated by the payment gateway common qrcode endpoint.",
        "parameters": [
          { "name": "address", "in": "query", "required": true, "schema": { "type": "string" } },
          { "name": "size", "in": "query", "schema": { "type": "integer", "default": 300, "minimum": 128, "maximum": 1024 } }
        ],
        "responses": {
          "200": { "description": "PNG QR code", "content": { "image/png": { "schema": { "type": "string", "format": "binary" } } } },
          "400": { "$ref": "#/components/responses/Error" },
          "502": { "$ref": "#/components/responses/Error" }
        }
      }
  ...
  "components": {
    ...
    "schemas": {
      ...
      "DepositAddressRequest": {
        "type": "object",
        "required": ["asset", "chain_key"],
        "properties": {
          "asset": { "type": "string", "example": "AVAX" },
          "chain_key": { "type": "string", "example": "avalanche" },
          "label": { "type": "string", "example": "AVAX avalanche" }
        }
      },
      "DepositAddress": {
        "type": "object",
        "properties": {
          ...
          "asset": { "type": "string", "example": "AVAX" },
          "chain_key": { "type": "string", "example": "avalanche" },
          "chain_id": { "type": "integer", "example": 43114 },
          "address": { "type": "string", "example": "0xGatewayGeneratedDepositAddress" },
          "wallet_id": { "type": "string" },
          "label": { "type": "string" },
          "qr_url": { "type": "string", "example": "/v1/payment-gateway/qrcode?address=0xGatewayGeneratedDepositAddress&size=300" }
        }
      },
      "WalletRequest": {
        "type": "object",
