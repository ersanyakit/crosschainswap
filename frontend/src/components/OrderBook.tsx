...
export default function OrderBookView({
  ...
  return (
    <div className="w-full bg-white dark:bg-[#0c1015] border border-[#e1e4e8] dark:border-[#21262d] rounded-lg shadow-sm flex flex-col h-[360px] sm:h-[430px] overflow-hidden text-gray-800 dark:text-gray-100 select-none">
